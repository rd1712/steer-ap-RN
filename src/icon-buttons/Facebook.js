...
function Facebook(props) {
  return (
    <TouchableOpacity>
      <Svg width={80} height={54} viewBox="0 0 80 54" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <G filter="url(#filter0_b)">
          <Rect width={80} height={54} rx={8} fill="url(#paint0_linear)" />
          <Rect x={1} y={1} width={78} height={52} rx={7} stroke="url(#paint1_linear)" strokeWidth={2} />
        </G>
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        />
        <Defs>
          <LinearGradient id="paint0_linear" x1={40} y1={0} x2={40} y2={54} gradientUnits="userSpaceOnUse">
            <Stop stopColor="#fff" stopOpacity={0.4} />
            <Stop offset={1} stopColor="#fff" stopOpacity={0.1} />
          </LinearGradient>
          <LinearGradient id="paint1_linear" x1={3.5} y1={4.22096e-7} x2={77} y2={56.5} gradientUnits="userSpaceOnUse">
